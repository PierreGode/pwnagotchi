...
class Display(View):
    ...
    def is_waveshare213_v4(self):
        return self._implementation.name == 'waveshare213_v4'
    ...
    def is_waveshare_any(self):
        return (
            self.is_waveshare_v1() or
            self.is_waveshare_v2() or
            self.is_waveshare_v3() or
            self.is_waveshare213_v4()
        )
